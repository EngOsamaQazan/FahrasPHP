...
class Xcrud_config
{
    ...
    public static $auto_editor_insertion = false; // inserts visual editor on textarea fields.
    ...
    // alert settings
    public static $email_from = 'info@shofe.net'; // email from address
    public static $email_from_name = 'موقع شو في بفلسطين'; // email from name
